...
const Guide = () => {
  ...
  return (
    <div className={gu.container}>
      ...
      <p className={gu.guideInfo} style={selectorGallSlice.dayNight ? {color: 'rgb(122, 152, 206)',} : {backgroundColor: '', color: '#1C274C', fontSize: '14px'}}>
                {selectorGallSlice.settings.languageSelector === 'English' ? '3. In the open window of the card, you can like it.': 
                selectorGallSlice.settings.languageSelector === 'Українська' ? '3. У відкритому вікні картки ви можете поставити лайк.': 
                selectorGallSlice.settings.languageSelector === 'Polska' ? '3. W otwartym oknie karty możesz ją polubić.' : 'In the open window of the card, you can like it.'}
      </p>
