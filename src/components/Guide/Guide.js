    ...
    <div className={gu.container}>
      ...
      <div className={gu.warnBlock}>
        ...
        <p className={gu.guideInfo} style={selectorGallSlice.dayNight ? {color: 'rgb(122, 152, 206)',} : {backgroundColor: '', color: '#1C274C', fontSize: '14px'}}>
                  {selectorGallSlice.settings.languageSelector === 'English' ? 'Pay attention! By registering on this resource, you acknowledge that your works may be copied by other registered people. This resource is demonstrative and experimental nature, but it can also be a full-fledged social network. So, if you notice that someone is passing off your work as their own, write to my mail (section "contacts"). The site is in test mode!': 
                  selectorGallSlice.settings.languageSelector === 'Українська' ? 'Зверніть увагу! Зареєструвавшись на цьому ресурсі, ви визнаєте те, що ваші роботи можуть бути скопійовані іншими зареєстрованими людьми. Данний ресурс має демонстративний та експериментальний характер, проте може бути й повноцінною соціальною мережею. Отже, якщо помітите, що хтось видає ваші роботи за звої - пишіть на мою пошту (розділ "контакти"). Сайт працює у тестовому режмі!': 
                  selectorGallSlice.settings.languageSelector === 'Polska' ? 'Zwróć uwagę! Rejestrując się w tym zasobie, potwierdzasz, że Twoje prace mogą być kopiowane przez inne zarejestrowane osoby. Zasób ten ma charakter demonstracyjny i eksperymentalny natura, ale może być również pełnoprawną siecią społecznościową. Jeśli więc zauważysz, że ktoś podaje Twoją pracę jako swoją, napisz na moją pocztę (sekcja „kontakty”). Strona jest w trybie testowym!' : 'Pay attention! By registering on this resource, you acknowledge that your works may be copied by other registered people. This resource is demonstrative and experimental, but it can also be a full-fledged social network. So, if you notice that someone is passing off your work as their own, write to my mail (section "contacts"). The site is in test mode!'}
        </p>
      </div>
      ...
      <p className={gu.guideInfo} style={selectorGallSlice.dayNight ? {color: 'rgb(122, 152, 206)',} : {backgroundColor: '', color: '#1C274C', fontSize: '14px'}}>
                {selectorGallSlice.settings.languageSelector === 'English' ? '2. Community. Here you can select any of the registered users and view his gallery of works. You can like it or express your impressions in the comments. You can also write a personal message. A commenting system is available in every section and on every card.': 
                selectorGallSlice.settings.languageSelector === 'Українська' ? '2. Громада. Тут ви можете вибрати будь-якого із зареєстрованих користувачів і переглянути його галерею робіт. Ви можете поставити лайк або висловити свої враження в коментарях. Ви також можете написати особисте повідомлення. Система коментарів доступна в кожному розділі та на кожній картці.': 
                selectorGallSlice.settings.languageSelector === 'Polska' ? '2. Społeczność. Tutaj możesz wybrać dowolnego zarejestrowanego użytkownika i obejrzeć jego galerię prac. Możesz dać lajka lub wyrazić swoje wrażenia za pomocą komentarza. Możesz także napisać wiadomość prywatną. System komentarzy dostępny jest w każdym dziale i na każdej karcie.' : 'Community. Here you can select any of the registered users and view his gallery of works. You can like it or express your impressions in the comments. You can also write a personal message. A commenting system is available in every section and on every card.'}
      </p>

      <p className={gu.guideInfo} style={selectorGallSlice.dayNight ? {color: 'rgb(122, 152, 206)',} : {backgroundColor: '', color: '#1C274C', fontSize: '14px'}}>
                {selectorGallSlice.settings.languageSelector === 'English' ? '3. In the open window of the card, you can like it. Use it with pleasure! I am waiting for comments and feedback)': 
                selectorGallSlice.settings.languageSelector === 'Українська' ? '3. У відкритому вікні картки ви можете поставити лайк. Користуйтеся ним із задоволенням! Чекаю коментарів та відгуків)': 
                selectorGallSlice.settings.languageSelector === 'Polska' ? '3. W otwartym oknie karty możesz ją polubić. Ciesz się z niego! Czekam na komentarze i opinie).' : 'In the open window of the card, you can like it. Use it with pleasure! I am waiting for comments and feedback)'}
      </p>
