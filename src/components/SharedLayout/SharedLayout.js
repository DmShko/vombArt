                        ...
                        return <li key={nanoid()}>
                          ...
                          {backgroundColor: '#384a83', color: 'rgb(122, 152, 206)', border: 'none',} : {backgroundColor: 'rgb(122, 152, 206)', color: '#384a83',} :
                           companionOpen[value] ? {backgroundColor: 'lightgray', color: 'white', border: 'none',} : {backgroundColor: 'white', color: '#384a83',}} onClick={togglePersoneBlock}>
                            {selectorGallSlice.users.find(element => element.uid === value).urlFoto !== '' ? <img src={selectorGallSlice.users.find(element => element.uid === value).urlFoto} style={{width: '40px', height: '40px', borderRadius: '50px',}} alt='user foto'></img> : <UserImg style={{width: '45px', height: '45px',}}/>}
