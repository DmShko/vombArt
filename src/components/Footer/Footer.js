  ...
  return (
    <>
      ...
      <div className={fo.container} style={selectorGallSlice.dayNight ? {backgroundColor: 'rgb(122, 152, 206)',} : {backgroundColor: '',}}>
        {selectorGallSlice.settings.languageSelector === 'English' ? <p>&#169; Home photo by Viktor Hanacek</p> : 
          selectorGallSlice.settings.languageSelector === 'Українська' ? <p>&#169; Фото головної сторінки - Viktor Hanacek</p> : 
          selectorGallSlice.settings.languageSelector === 'Polska' ? <p>&#169; Zdjęcie domowe autorstwa Wiktora Hanacka</p> : <p>&#169; Home photo by Viktor Hanacek</p>}
      </div>
      <div className={fo.container} style={selectorGallSlice.dayNight ? {backgroundColor: 'rgb(122, 152, 206)',} : {backgroundColor: '',}}>
